...
var pushStateHook = function(url) {
  ...
  return function(req, res, next) {
    ...
    // https://kruxdigital.jira.com/wiki/display/krux/Red+Bull+Server+Routing
    if (path === '/' ||
...
var reverseProxyApiRequest = function (host, port) {
  ...
  grunt.initConfig({
    ...
    coffee: {
      ...
      dist: {
        ...
        files: {
          '.tmp/scripts/app.js': '<%= yeoman.app %>/scripts/**/*.coffee'
        }
      },
      test: {
        files: [{
